...
require (
	...
	github.com/DataDog/datadog-agent/pkg/otlp/model v0.39.0-rc.5
	github.com/DataDog/datadog-agent/pkg/quantile v0.39.0-rc.5
	github.com/DataDog/datadog-agent/pkg/trace v0.39.0-rc.5
...
require (
	...
	github.com/DataDog/datadog-agent/pkg/obfuscate v0.39.0-rc.5 // indirect
	github.com/DataDog/datadog-agent/pkg/remoteconfig/state v0.39.0-rc.5 // indirect
